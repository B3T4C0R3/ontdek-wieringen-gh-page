  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      ow: {
        ...
        'header_#kaart': 'Map',
        'header_#legenda': 'Legend',
        Overnachten: 'Hotels/Campings',
        Winkels: 'Shops',
        Bezienswaardigheden: 'Sights',
        Bedrijven: 'Companies',
        Recreatie: 'Entertainment',
        'Uitgaan & Eten': 'Diner',
        Cultuur: 'Culture',
        ...
        about2_schat_title: 'Viking treasure',
        about2_schat_text:
          "For those who don't know Wieringen, Wieringen is old, very old. For example, the Vikings honored it with a visit in about 850 AD, as evidenced by the Viking treasure that was found in 1996 and is on display in the National Museum of Antiquities in Leiden. Until the mid-1920s, Wieringen was a small island in the Zuiderzee.",
        about2_kotter_title: 'Villages',
        about2_kotter_text:
          'The former island consists of the villages Den Oever, Oosterland, Hippolytushoef and Westerland. In addition, there are several neighborhoods. The landscape is slightly sloping. Several old buildings have been preserved and beautifully restored, such as one of the oldest churches in the Netherlands, the Michaëlskerk in Oosterland from the early 12th century. The other villages also have their characteristic points. Den Oever is characterized by the harbor, where a fresh fish market is held every week, and the beautiful flour mill from 1672 in the middle of the village. Hippolytushoef is the largest village with the large church proudly as the center and around it some historic buildings. Westerland has the highest point of the former island and borders the Amstelmeer.',
        about2_wieringen_title: 'Culture',
        about2_wieringen_text:
          'Wieringen has its own dialect. Unfortunately, not many people speak it well anymore. Although this is very unfortunate, it has an advantage for visitors: You will have no trouble understanding the people. Although there is still much more to say about the former island, the villages, the hamlets and the inhabitants, we especially invite you to experience it for yourself and... “Efkes een rongdje te lópe…”',
